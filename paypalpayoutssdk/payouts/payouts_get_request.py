...
class PayoutsGetRequest:
    ...
    """
    def __init__(self, payout_batch_id):
        self.verb = "GET"
        self.path = "/v1/payments/payouts/{payout_batch_id}?".replace("{payout_batch_id}", quote(str(payout_batch_id)))
        self.headers = {}
